          ...
          <div class="col-md-3">
            ...
            <div class="col-md-7 well">
              ...
              <form name="userForm" novalidate>
                  ...
                  <input type="text" class="form-control" name="name" ng-model="user.name" required placeholder="Mật khẩu cũ" />
                  </div>
                  <div class="form-group" ng-class="{ 'has-error': userForm.name2.$invalid && userForm.name2.$dirty }" >
                  <label class="control-label">Mật Khẩu Mới: </label>
                  <input type="text" class="form-control" name="name2" ng-model="user.name2" required placeholder="Xác nhận mật khẩu" />
                  </div>
                  <div class="form-group" ng-class="{ 'has-error': userForm.name1.$invalid && userForm.name1.$dirty }" >
                  <label class="control-label">Xác Nhận Mật Khẩu: </label>
                  <input type="text" class="form-control" name="name1" ng-model="user.name1" required placeholder="Xác nhận mật khẩu" />
                  </div>
                  <div class="form-group" style="text-align: right; padding-top: 10px;padding-bottom: 10px">
                    <a href="TruongKhoa_Home.jsp " class="btn btn-primary" role="button" style="float=right" ng-click="save()"> Xác Nhận </a>
