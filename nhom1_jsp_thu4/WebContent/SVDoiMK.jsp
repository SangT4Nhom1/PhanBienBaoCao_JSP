          ...
          <div class="col-md-3">
            ...
            <div class="col-md-7 well">
              ...
              <div class="form-group">
                  ...
                  <input class="form-control" id="inputlg" type="text" placeholder="Nhập Mật Khẩu Cũ ...">
              </div>
              
              <div class="form-group">
                  <label for="inputlg">Nhập Mật Khẩu Mới: </label>
                  <input class="form-control" id="inputlg" type="text" placeholder="Nhập Mật Khẩu Mới ...">
              </div>
              ...
              <div class="form-group" style="text-align: right; padding-top: 10px;padding-bottom: 10px">
                <a href=" -Link- " class="btn btn-info" role="button"> Trở Về </a>
                <a href=" -Link- " class="btn btn-info" role="button"> Xác Nhận </a>
              </div>
              </div>            
